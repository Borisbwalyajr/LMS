...
function loadContent(contentType = 'dashboard') { // Default to 'dashboard'
    ...
    switch(contentType) {
        case 'dashboard':
            ...
            break;
        case 'users':
            url = 'users.php'; // Path to the registered users content file
            break;
        case 'pending':
            url = 'pending.php'; // Path to the profile content file
            break;
        case 'approved':
            url = 'approved.php'; // Path to the profile content file
            break;
        case 'overdue':
